...
def add_no_data_error():
    ...
    QMessageBox.about(window, "Empty Data Input", "Sorry, empty info cannot be added. Please make sure you actually write something before adding it to the dictionary.")
